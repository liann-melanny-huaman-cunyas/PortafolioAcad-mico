                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-5">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col-md-6">
                            <form id="checkout-form" action="./checkout.php" method="POST" onsubmit="totalamount()">
                                <input type="hidden" id="precio-total" name="precio-total" value="<?php echo totalAcumuladoDeuda($con); ?>">
